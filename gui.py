...
def facial_expression_model_definition(json_file, weights_file):
...
facec = cv2.CascadeClassifier("GUI.xml")
model = facial_expression_model_definition("model_a.json", "model_weight.weights.h5")
